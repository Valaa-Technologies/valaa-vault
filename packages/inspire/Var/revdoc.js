...
const title = `The valosheath 'Var' namespace reference`;
...
module.exports = {
  ...
  respecConfig: {
    ...
    shortName: "varNamespace",
    editors: authors("iridian"),
    authors: authors("iridian"),
  },
  "chapter#abstract>0": {
    "#0": [
`This document is a revdoc template document 'varNamespace' created by
write-revdoc.`,
    ],
  },
  "chapter#sotd>1": {
...
ref("VDoc specification", "@valos/vdoc"), ` for reference documentation.`,
  ...
  "chapter#section_valosheath>8": {
    ...
    "chapter#section_classes>2": {
      ...
      "#0": [
"This section describes valosheath classes introduced by the 'Var' namespace",
      ],
      "table#>0;vocabulary": {
    ...
    "chapter#section_properties>3": {
      ...
      "#0": [
"This section describes valosheath properties introduced by the 'Var' namespace",
      ],
      "table#>0;vocabulary": {
        "VDoc:columns": {
    ...
    "chapter#section_methods>4": {
      ...
      "#0": [
"This section describes valosheath methods introduced by the 'Var' namespace",
      ],
      "table#>0;vocabulary": {
    ...
    "chapter#section_globals>5": {
      ...
      "#0": [
"This section describes valosheath global objects introduced by the 'Var' namespace",
      ],
      "table#>0;vocabulary": {
