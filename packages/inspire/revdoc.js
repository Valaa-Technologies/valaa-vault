...
ref("VDoc specification", "@valos/vdoc"), ` for reference documentation.`,
  ...
  "chapter#section_fabric>9": {
    ...
    "chapter#section_classes>2": {
      ...
      "#0": [
"This section describes fabric classes introduced by the 'VInspire' namespace",
      ],
      "table#>0;vocabulary": {
    ...
    "chapter#section_properties>3": {
      ...
      "#0": [
"This section describes fabric properties introduced by the 'VInspire' namespace",
      ],
      "table#>0;vocabulary": {
    ...
    "chapter#section_methods>4": {
      ...
      "#0": [
"This section describes fabric methods introduced by the 'VInspire' namespace",
      ],
      "table#>0;vocabulary": {
    ...
    "chapter#section_globals>5": {
      ...
      "#0": [
"This section describes fabric global objects introduced by the 'VInspire' namespace",
      ],
      "table#>0;vocabulary": {
