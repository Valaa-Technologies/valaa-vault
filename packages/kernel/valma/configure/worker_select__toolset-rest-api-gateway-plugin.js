...
exports.brief = "select 'toolset-rest-api-gateway-plugin'";
exports.describe = "Select the worker toolset 'toolset-rest-api-gateway-plugin'";
exports.introduction =
`This toolset extends a perspire worker workspace with REST-style
