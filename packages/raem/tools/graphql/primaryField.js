...
export default function primaryField (targetFieldName, type, description,
  ...
  const ret = {
    [targetFieldName]: {
      ...
      isOwning: additionalDescriptors.coupling && additionalDescriptors.coupling.isOwning,
      isOwned: additionalDescriptors.coupling && additionalDescriptors.coupling.isOwned,
      ...additionalDescriptors,
    },
  };
  return ret;
