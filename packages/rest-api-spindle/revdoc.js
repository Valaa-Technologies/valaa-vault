...
pkg("@valos/rest-api-spindle"), ` and part of the domain `,
pkg("@valos/kernel"), `.
...
is fixed at what the underlying fastify web server consumes.`,
  ...
  "chapter#introduction>2;REST API routes map to valospace resources": {
    "#0": [
...
from a `, em("rest API provider"), ` by providing only the mapping
...
The sub-library `, ref("schema-builder", "@valos/rest-api-spindle/schema-builder"), `
