...
`[{
  "@context": [{
    ...
    "/-out-": { "@id": "$V:pairedOutRelation", "@type": "@id", "@container": "@list" },
    "/-in-": { "@id": "$V:pairedInRelation", "@type": "@id", "@container": "@list" },
    ...
    "--/-out": { "@id": "--$V:outRelation", "@type": "@id", "@container": "@list" },
    "--/-in": { "@id": "--$V:inRelation", "@type": "@id", "@container": "@list" },
    "--/-out-": { "@id": "--$V:pairedOutRelation", "@type": "@id" },
    "--/-in-": { "@id": "--$V:pairedInRelation", "@type": "@id" },
    "--/-out--": { "@id": "--$V:ownsOutRelation", "@type": "@id", "@container": "@list" },
    "--/-in--": { "@id": "--$V:ownsInRelation", "@type": "@id", "@container": "@list" },
