...
exports.command = ".configure/.type/.opspace/@valos/toolset-opspace";
exports.describe = "Configure 'toolset-opspace' for an opspace workspace";
...
root from package @valos/toolset-opspace directory templates/.*.
...
exports.builder = (yargs) => yargs.options({
  reconfigure: {
    ...
    description: "Reconfigure 'toolset-opspace' config of this workspace.",
  },
});
