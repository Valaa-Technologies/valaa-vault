...
exports.builder = (yargs) => yargs.options({
  ...
  editors: {
    ...
    description: "The revdoc editors' names as specified in toolset-vault.revdoc.authors",
    interactive: { type: "input", when: "if-undefined" },
  },
  authors: {
    type: "string", array: true,
    description: "The revdoc authors' names as listed in toolset-vault.revdoc.authors",
    interactive: { type: "input", when: "if-undefined" },
  },
  tutorial: {
