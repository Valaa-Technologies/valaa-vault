...
module.exports = {
  domain: "@valos/kernel",
  preferredPrefix: "VDoc",
  baseIRI: "https://valospace.org/vdoc/0#",
  namespaceModules: {
...
outside the document structure itself.`,
  ...
  vocabulary: _createVDocVocabulary(),
...
function _createVDocVocabulary () {
  return {
    ...
    lines: { "@type": "VDoc:Property",
      "rdfs:subPropertyOf": "VDoc:entries",
      "rdfs:domain": "VDoc:Node",
      "rdfs:range": "rdfs:List",
      "rdfs:comment": "A visible list of visually separate lines",
    },
...
`Node content is collapsed but expandable. If false, content is expanded but collapsible`,
    ...
    context: { "@type": "VDoc:Property",
      ...
      "rdfs:range": "rdfs:Resource",
      "rdfs:comment": "Possibly non-visible context base (absolute or relative to current base)",
    },
...
function _createVdocExtractionRules () {
  return {
    ...
    bulleted: {
      range: "VDoc:BulletList", owner: "VDoc:content", body: "VDoc:lines",
      comment: "Bulleted list",
    },
    numbered: {
      range: "VDoc:NumberedList", owner: "VDoc:content", body: "VDoc:lines",
